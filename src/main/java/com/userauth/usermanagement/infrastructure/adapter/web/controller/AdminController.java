...
import com.userauth.usermanagement.infrastructure.adapter.web.dto.UserResponse;
...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse<Page<UserResponse>>> getUsers(
        ...
        Page<com.userauth.usermanagement.domain.user.entity.User> users = userRepository.findAll(pageable);
    ...
    public ResponseEntity<ApiResponse<UserResponse>> toggleUserStatus(@PathVariable UUID id) {
        return userRepository.findById(id)
                .map(user -> {
                    ...
                    com.userauth.usermanagement.domain.user.entity.User savedUser = userRepository.save(user);
                    UserResponse response = UserResponse.builder()
                            .id(savedUser.getId())
